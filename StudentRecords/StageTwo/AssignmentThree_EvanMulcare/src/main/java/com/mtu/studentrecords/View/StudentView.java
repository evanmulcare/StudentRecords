...
public class StudentView extends VBox {
    ...
    StudentController studentCntrl = new StudentController();
    ...
    private void buildUI() {
        ...
        studentCntrl.loadFile(addList);
        studentCntrl.populateHandle(table,  addList);
    }
    ...
    private HBox addHBox() {
        ...
        loadButton.setOnAction(actionEvent -> studentCntrl.loadHandle( addList));
        buttonStyle(loadButton, "-fx-background-color: #e6b23c;");

        saveButton.setOnAction(actionEvent -> studentCntrl.saveHandle( addList));
        buttonStyle(saveButton, "-fx-background-color: #e6b23c;");

        listButton.setOnAction(actionEvent -> studentCntrl.populateHandle(table,  addList));
    ...
    private HBox addHBoxTop() {
       ...
       addButton.setOnAction(actionEvent -> studentCntrl.showCreateDialogHandle());
       buttonStyle(addButton, "-fx-background-color: #3e8cc8;");

        removeButton.setOnAction(actionEvent -> studentCntrl.removeHandle(table, addList));
