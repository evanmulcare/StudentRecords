    ...
    private HBox addHBoxTop() {
        ...
        searchButton.setOnAction(e -> {
            ...
            for (Module module : addModuleList) {
                if (module.getTitle().toLowerCase().contains(searchText)) {
                    filteredModules.add(module);
                }
            }
            moduleCtrl.populateModuleHandle(filteredModules);
        });

        hbox.getChildren().addAll(heading, spacer, searchField, searchButton);
