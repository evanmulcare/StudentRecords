...
public class CreateView extends Dialog<Student> implements Serializable {
    ...
    private Pane createGridPane()
    {
        ...
        private static boolean studentIdAlreadyExists(String studentId) {
